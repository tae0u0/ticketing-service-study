...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, DomainEvent> reservationConsumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, DomainEvent> reservationKafkaListenerContainerFactory() {
